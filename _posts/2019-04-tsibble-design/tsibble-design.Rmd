...
A longer version of the data structure and design principles about the **tsibble** R package can be found at arXiv (<https://arxiv.org/abs/1901.10257>).
